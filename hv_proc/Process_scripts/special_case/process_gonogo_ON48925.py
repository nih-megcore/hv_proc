...
response_chan = 'UADC007'
filename = '/fast/BIDS_HV_V1/bids/sub-ON48925/ses-01/meg/sub-ON48925_ses-01_task-gonogo_run-01_meg.ds'
logfile = '/fast/BIDS_HV_V1/bids/ON48925_logs/GoNoGo-s-ON48925-r001-.log'
...
def main(filename=None, logfile=None, write_mrk_file=True):
    ...
    response = threshold_detect(dsname=filename, mark='response', deadTime=0.5, 
                     derivThresh=0.5, channel=response_chan)
